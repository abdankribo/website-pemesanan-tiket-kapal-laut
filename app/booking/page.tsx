...
export default async function BookingPage() {
  ...
  return <main className="min-h-screen bg-surface px-3 pb-32 pt-20 sm:px-6 sm:pt-24"><div className="mx-auto max-w-2xl">
    <header className="mb-6 flex items-center justify-between"><div><p className="text-[10px] font-bold uppercase tracking-[.3em] text-secondary">Your Booking</p><h1 className="text-2xl font-black text-primary">Pesan Tiket Kapal</h1></div><Link href="/" className="text-sm font-bold text-primary">Dashboard</Link></header>
