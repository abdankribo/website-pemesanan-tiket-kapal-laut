    ...
    <main className="min-h-screen px-4 py-10 pb-28">
      <div className="mx-auto max-w-lg">
        ...
        <div className="site-gradient overflow-hidden rounded-[2rem] p-6 text-white shadow-2xl shadow-blue-950/15 sm:p-7">
          <div className="flex items-start justify-between gap-4"><div><p className="text-[10px] uppercase tracking-[.3em] text-[#27F5F5]">Digital Boarding Pass</p><h1 className="mt-2 text-3xl font-black">{ticket.origin} → {ticket.destination}</h1></div><span className={`rounded-full px-3 py-1 text-[10px] font-black ${verified?"bg-[#27F5F5] text-primary":"bg-[#E0FF00] text-primary"}`}>{verified?"VERIFIED":"READY"}</span></div>
        ...
        <div className="aesthetic-card mt-4 rounded-[2rem] p-6 text-center">
          <p className="text-xs font-black uppercase tracking-[.2em] text-[#00B4FF]">{verified?"Tiket sudah diverifikasi":"Scan QR saat boarding"}</p>
